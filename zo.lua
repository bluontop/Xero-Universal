...
game.StarterGui:SetCore("SendNotification", {Title = "Xero", Text = "Xero Universal is loading", Icon = "rbxassetid://505845268", Duration = 5, Button1 = "Okay"})
wait(3)
local Window = Library.CreateLib("Xero Universal                                    V1", "Synapse")

-- animation
local Anim = Window:NewTab("Animations")
local AnimSection = Anim:NewSection("FE Animations")
AnimSection:NewButton("FE Backflip + Frontflip", "ButtonInfo", function() -- backflip + frontflip skid
    wait(5)
...
AnimSection:NewLabel("Z,X,C")
AnimSection:NewButton("Nullware", "Nullware Hub/GUI", function() -- Nullware
...
local Combat = Window:NewTab("Combat") -- combat
local CombatSection = Combat:NewSection("Combat Stuff")
CombatSection:NewButton("Owlhub", "load owlhub script", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))();
end)
CombatSection:NewButton("shit aimlock", "bad aimlock", function()
...
local Movement = Window:NewTab("Movement") --movemtn section
local MovementSection = Movement:NewSection("Movement shi")

MovementSection:NewButton("Shit Flight", "self explanatory", function() -- bad flight
...
MovementSection:NewSlider("Speed", "Modify the amount of speed applied", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)
MovementSection:NewLabel("Speed can be used as a fake macro")


local Info = Window:NewTab("Info") -- mstuff abt the client
local InfoSection = Info:NewSection("Info")
InfoSection:NewLabel("not my ui library")
InfoSection:NewLabel("thanks for using this shit script")
InfoSection:NewLabel("made by blu#7720")
InfoSection:NewButton("click and check console for ui", "...", function()
    print("https://xheptcofficial.gitbook.io/kavo-library/")
end)
MovementSection:NewButton("CTRL + Click TP", "dont use if sprint keybind is ctrl", function()
    game.StarterGui:SetCore("SendNotification", {Title = "Xero", Text = "Not recommended if the sprint key is ctrl", Icon = "rbxassetid://505845268", Duration = 5, Button1 = "Okay"})
...
InfoSection:NewTextBox("dev console text", "self explanatory", function(txt)
	print(txt)
end)
InfoSection:NewKeybind("Keybind", "view and change the gui keybind", Enum.KeyCode.RightShift, function()
	Library:ToggleUI()
end)
InfoSection:NewButton("Infinite Yield", "man", function() -- Infinite Yield
	...
	addcmd('tpwalk', {'teleportwalk'}, function(args, speaker)
		...
		while tpwalking and chr and hum and hum.Parent do
			...
			if hum.MoveDirection.Magnitude > 0 then
				if args[1] and isNumber(args[1]) then
					chr:TranslateBy(hum.MoveDirection * tonumber(args[1]) * delta)
				else
					chr:TranslateBy(hum.MoveDirection * delta)
				end
			end
		end
	end)
